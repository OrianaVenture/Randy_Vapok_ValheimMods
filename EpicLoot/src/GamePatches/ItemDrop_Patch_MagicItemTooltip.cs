        ...
        private static bool Prefix(ref string __result, ItemDrop.ItemData item, int qualityLevel)
        {
            ...
            switch (item.m_shared.m_itemType)
            {
                ...
                case ItemDrop.ItemData.ItemType.Torch:
                    ...
                    bool FortifyAura = magicItem.HasEffect(MagicEffectType.FortifyAura);
                    string FortifyAuraColor = FortifyAura ? magicColor : "orange";
                    if (FortifyAura)
                    {
                        float FortifyAuraValue = magicItem.GetTotalEffectValue(MagicEffectType.FortifyAura, 1f);
                    }
