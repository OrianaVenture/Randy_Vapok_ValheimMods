...
public static partial class API
{
    ...
    {
        if (!RuntimeRegistry.TryGetValue(key, out AbilityDefinition definition)) return false;
        if (!player.TryGetComponent(out AbilityController controller)) return false;
